  ...
  &nbsp;<div class ="content">
       ...
       <h1>Register </h1>
            ...
            <div class="floating-box">
               ...
               <asp:TextBox ID="txtEmail" runat="server" Width="495px" style="margin-left: 6px" CssClass="FBtxtbox" Height="23px"></asp:TextBox>
            </div>
        ...
        <div class="floating-box">
            ...
            <asp:TextBox ID="txtName" runat="server" Width="491px" Height="30px" style="margin-left: 4px; margin-top: 11px; margin-bottom: 0px;" CssClass="FBtxtbox"></asp:TextBox>
            <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:TextBox ID="txtpassword" runat="server" Height="22px" TextMode="Password" Width="399px"></asp:TextBox>
&nbsp;<br />
                ...
                <div class="floating-box">
                    ...
                    <asp:TextBox ID="txtReenterPassword" runat="server" CssClass="FBtxtbox" Height="23px" Width="395px" TextMode="Password"></asp:TextBox>
&nbsp;</div>
       <div class="floating-box">
            <asp:Label ID="lblAddress" runat="server" Text="Address"></asp:Label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="txtAddress" runat="server" Width="458px" style="margin-left: 0px" CssClass="FBtxtbox" Height="26px"></asp:TextBox>
        </div>
            <div class="floating-box">
            &nbsp;&nbsp;&nbsp;
            <asp:Label ID="lblCity" runat="server" Text="City"></asp:Label>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="txtCity" runat="server" style="margin-left: 0px" Width="458px" CssClass="FBtxtbox" Height="30px"></asp:TextBox>
        </div>

            <div class="floating-box">
            &nbsp;<asp:Label ID="lblState" runat="server" Text="State"></asp:Label>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="txtState" runat="server" Height="26px" Width="461px" MaxLength="2"></asp:TextBox>
        </div>
        <div class="floating-box">
            <asp:Label ID="lblZip" runat="server" Text="Zipcode"></asp:Label>
            &nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="TextBox5" runat="server" Width="464px" Height="35px" MaxLength="5"></asp:TextBox>
        </div>
